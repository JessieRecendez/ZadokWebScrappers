...
# Next Page in url such as page 2, page 3, page 4, etc... Button link always updates
...
while True:
    next_page += 1
    response = requests.get(f"{url}?page={next_page}")  # ?page= may need to be adjusted by website
